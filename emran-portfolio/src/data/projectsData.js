...
export const projectsData = [
    {
        ...
        projectDesc: "Une application Créée à partir d'une API qui permet aux utilisateurs de se renseigner sur la météo de n'importe quelle ville du monde. changement background-image selon de la météo. Les utilisateurs peuvent ajouter 3 favoris  dans le Favorites (stockage local)",
